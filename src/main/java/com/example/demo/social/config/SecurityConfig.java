...
import com.example.demo.social.OAuth2.OAuth2UserInfoService;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(request -> request.requestMatchers("/", "/api/login/oauth2/*", "/api/health").permitAll()   //우리 userService requestMapping
                ...
                .oauth2Login(oauth2 -> oauth2
                        ...
                        .userInfoEndpoint(endpoint -> endpoint.userService(oauth2UserInfoService))
                )
